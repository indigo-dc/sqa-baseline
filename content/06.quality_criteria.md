...
### Code metadata
Metadata for the software component, is a way to facilitate the citation of
that component [@url:http://dx.doi.org/10.7717/peerj-cs.86] and to have assigned
a Digital Object Identifier (DOI). Is is also key
towards preservation, discovery, reuse, and attribution of the software component.

A metadata file SHOULD exist along side the code, under its Version Control System (VCS).
